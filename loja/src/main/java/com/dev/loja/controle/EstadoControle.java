...
public class EstadoControle {
	...
	@GetMapping("/administrativo/estados/cadastrar") //vai ser editado e ser repassado para a visão que vai ser rederizada
	...
	public ModelAndView salvar(Estado estado, BindingResult result) { //vamos trabalhar com validações anotação @Valid  não pega
